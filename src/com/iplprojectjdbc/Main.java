...
public class Main {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        findMatchesPlayedPerYear(connection,statement);
        findTotalMatchesPlayedByTeams(connection,statement);
        findExtraRunsScoredIn2016(connection,statement);
        findTopEconomicalBowler2015(connection,statement);
        statement.close();
        connection.close();
    }

    static void findMatchesPlayedPerYear(Connection connection, Statement statement) throws SQLException {
    ...
    static void findTotalMatchesPlayedByTeams(Connection connection, Statement statement) throws SQLException{
    ...
    static void findExtraRunsScoredIn2016(Connection connection, Statement statement) throws SQLException{
    ...
    static void findTopEconomicalBowler2015(Connection connection, Statement statement) throws SQLException{
